...
[English](https://github.com/kapee1/soroka/blob/main/build%20guides/Soroka%20v2%20Build%20guide%20%5BEN%5D.md) | [Russian](https://github.com/kapee1/soroka/blob/main/build%20guides/Soroka%20v2%20Build%20guide%20%5BRU%5D.md)
...
* Compatible with most base-kit keycap sets. No 40s add-ons needed.
* Optional Panasonic EVQWGD001 or EC-11 encoder
* Plate also optional. You can build a keyboard without a plate to reduce cost.
...
| Soroka Panel | 1 |
| Soroka Spacer | 1 |
| Oval feet 22×4×1.5mm | 4 |
| Silicone washers 2×5×1 | 9 |
| M2 × 4mm Screws | 13 |
| M2 Inserts 3mm (OD3.2) | 13 |
| Round magnets 3×1mm | 8 |

## Optional Cover Assembly

If using a cover with screws, you don't need a spacer and magnets. Instead, you will need:

| Part | Quantity |
|------|----------|
| M2 × 5mm Screws | 8 |
| M2 Brass Standoffs Female-Female 11mm | 4 |
